          ...
          <>
            <div className="readout-grid" style={{ marginBottom: 18 }}>
              <div className="readout-tile" style={{ cursor: "default" }}>
                ...
                <div>
                  <span className="readout-value">{data.todayTotalMm ?? "—"}</span>
              ...
              <div className="readout-tile" style={{ cursor: "default" }}>
                ...
                <div>
                  <span className="readout-value">{data.weekTotalMm ?? "—"}</span>
                  <span className="readout-unit">mm</span>
                </div>
              </div>
              <div className="readout-tile" style={{ cursor: "default" }}>
                ...
                <div>
                  <span className="readout-value">{data.monthTotalMm ?? "—"}</span>
                  <span className="readout-unit">mm</span>
                </div>
              </div>
              <div className="readout-tile" style={{ cursor: "default" }}>
                ...
                <div>
                  <span className="readout-value">{data.maxSingleReadingMm ?? "—"}</span>
                  <span className="readout-unit">mm</span>
                </div>
              </div>
            </div>
